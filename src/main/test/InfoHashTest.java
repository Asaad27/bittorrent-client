...
public class InfoHashTest {
	...
	public void testFile1() throws IOException, NoSuchAlgorithmException {
		TorrentFileController torrentHandler = new TorrentFileController(new FileInputStream("src/main/resources/torrents/hello_world.txt.torrent"));
	...
	public void testFile2() throws IOException, NoSuchAlgorithmException {
		TorrentFileController torrentHandler = new TorrentFileController(new FileInputStream("src/main/resources/torrents/iceberg.jpg.torrent"));
		TorrentMetaData torrentMetaData = torrentHandler.ParseTorrent();
	...
	public void testFile3() throws IOException, NoSuchAlgorithmException {
		TorrentFileController torrentHandler = new TorrentFileController(new FileInputStream("src/main/resources/torrents/test.torrent"));
		TorrentMetaData torrentMetaData = torrentHandler.ParseTorrent();
